...
const SEED_MECHANICS: MechanicProfile[] = [
  {
    ...
    last_name: 'Bouchard',
    email: 'marc.mecanicien@wrenchmobile.ca',
    phone: '+1 (514) 555-0144',
    business_name: 'Mécano Mobile Sceau Rouge',
    bio: 'Maître mécanicien automobile certifié Sceau Rouge avec 12+ années d’expérience en concession et service mobile. Équipé d’un scanner OBD-II professionnel, de crics hydrauliques et d’un laboratoire de test de batterie.',
    years_experience: 12,
    city: 'Montréal',
    province: 'QC',
    latitude: 45.5017,
  ...
  },
  {
    ...
    first_name: 'Sarah',
    last_name: 'Kowalski',
    email: 'sarah.k@mobileauto.ca',
    phone: '+1 (416) 555-0188',
    business_name: 'Apex Diagnostic Mobile',
    bio: 'Spécialiste en diagnostic électrique véhicules européens et nord-américains, freins et alternateurs. 8 ans d’expérience sur les routes.',
    years_experience: 8,
    city: 'Toronto',
    province: 'ON',
    latitude: 43.6532,
  ...
  },
  {
    ...
    last_name: 'Gagnon',
    email: 'alex.gagnon@proservice.ca',
    phone: '+1 (418) 555-0112',
    business_name: 'Service Mobile Québec Pro',
    bio: 'Fourgon d’atelier complet pour vidanges, changements de pneus, freins et recharge rapide de batterie.',
    years_experience: 5,
    city: 'Québec',
    province: 'QC',
    latitude: 46.8139,
